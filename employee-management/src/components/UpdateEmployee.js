...
const UpdateEmployee = () => {
    ...
    const [employee, addEmployee ] = useState({
     ...
     const updateEmployeeDetails = (e) => {
      ...
      {
          EmployeeService.updateEmployeeByID(employee).then(
              (response)=>{
    ...
    <div className="flex max-w-md mx-auto shadow  border-b mt-10">
        <div className="px-8 py-8">
           ...
           <div className="items-center justify-center h-14 w-full my-4">
                ...
                className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mt-2">Update
                </button>
                <button 
                type="button" 
                onClick={GoBack}
                className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mx-40">Back</button>
           </div>
        </div>
